        ...
        if ($status->status == 'registrasi') {
            ...
            if ($siswa) {
                ...
                if (!$presensi) {
                    ...
                    $statusPresensi = (strtotime($waktu) > strtotime($setting->start_time)) ? 'Telat' : 'Tepat Waktu';
                    ...
                    if (strtotime($waktu) < strtotime($setting->end_time)) {
    ...
    public function generate_absen_tidak_hadir_otomatis()
{
    ...
    // 4. Cek apakah sekarang lebih dari 1 jam setelah jam masuk
    ...
    // 6. Loop siswa dan cari yang belum presensi
